...
///
/// Il exerce réellement le pont : les valeurs affichées proviennent du domaine
/// Rust, y compris le résultat de cinq transitions de la machine à états
/// d'appel. Si cet écran s'affiche, le chargement de la bibliothèque, la
/// génération des bindings et la logique métier fonctionnent.
///
/// Conservé après la Phase 0 : c'est le moyen le plus rapide de diagnostiquer
/// une installation défaillante, et il ne coûte rien à maintenir.
library;
